Http request is what a user sends to a web server to interact with the web application and make something happen.
...
HTTP Methods
    ...
    GET
        Used to fetch data from the server without making any changes. Reminder! Make sure we are only exposing data the user is allowed to see. Avoid putting sensitive info like tokens or passwords in GET requests since they can show up as plaintext.
...
Besides these common methods, there are a few others used in specific cases:
    ...
    OPTIONS
        Tells us what methods are available for a specific resource, helping clients understand what they can do with the server.
...
Following these practices helps protect the web application from common attacks.
